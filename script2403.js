...
let AkshataA = new Person()
let SaurabhA = new Person()
console.log(AkshataA.firstName)
console.log(AkshataA.lastName)
AkshataA.displayName()

console.log(SaurabhA.firstName)
console.log(SaurabhA.lastName)
SaurabhA.displayName()
